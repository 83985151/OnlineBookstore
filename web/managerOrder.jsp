    ...
    <div id="base" class="">
      ...
      <div id="u74" class="ax_default box_1">
        ...
        <div id="u74_text" class="text " style="display:none; visibility: hidden">
          <p><tbody id="orderlist" style="position:relative;top: 350px;left: 270px;right: 800px;bottom: 100px">
          <m:forEach items="${orderList}" var="order">
            <tr>
              <td>${order.username}</td>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${order.oid}</td>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${order.payment}</td>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="findOrderById?oid=${order.oid}">修改付款情况</a>&nbsp;
                <a href="delOrder?oid=${order.oid}">删除</a>
              </td>
            </tr>
          </m:forEach>
          </tbody></p>
      ...
      <div id="u78" class="ax_default _二级标题">
        ...
        <div id="u78_text" class="text ">
          <p><span>请输入您想要管理的用户账号：</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <form action="seachOrderByUsername" method="post">
